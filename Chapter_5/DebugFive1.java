...
public class DebugFive1{
   public static void main(String args[]){
      ...
      int usersChoice;
      double bill = 0.0; // The variable 'bill' didn’t have a value before, so we initialized it to 0.0 to avoid errors. 
      ...
      if(usersChoice == 1){ //using only one '=' sign means to assign, instead we use a double '='/'==' to compare
      bill = bill + LOW_PRICE;
      System.out.println("Total bill is " + bill); //missing a double qoutation for the "Total bill is" 
      }   
   }
}
