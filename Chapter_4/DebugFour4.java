...
public class DebugFour4{
   public static void main(String args[]){
      ...
      DebugTrip trip1;
      DebugTrip trip2;
      DebugTrip trip3; //two variables with the same name. fixed from trip2 to trip3
   ...
   public static void display(DebugTrip trip){
      ...
      System.out.println(" Leaving from " + trip.getDepartureCity()); //typo error fixed from "trp.getDepartureCity()" to trip.getDepartureCity()
